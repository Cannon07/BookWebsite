...
![image](/BookWebsite/figures/non_interacting_systems/Fig1b.png)
![Thermodynamic functions for the 2-state model. The first figure shows
$F/(Nk_BT)$ (solid curve), $E/(Nk_BT)$ (dashed curve), and $S/(Nk_B)$
(dashed-dotted curve) versus $k_BT/\varepsilon_0$; the dashed curve
gives the asymptotic value for entropy $S \rightarrow k_B \log 2$ at
large $T$. The figure below shows the energy $E/(N\varepsilon_0)$ versus
$k_BT/\varepsilon_0$.](/BookWebsite/figures/non_interacting_systems/Fig1a.png)
...
([$$Helmholtz_Cano$$]\{reference-type="ref"
