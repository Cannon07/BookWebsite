...
<style jsx global>{`
  ...
  /* Other styles... */
`}</style>
# Deep Electronic Schrödinger Equations 
...
Ansatz](figures/Differentiable Physics/Deep Quantum/Deep Electronic Schrodingers/paulinet Ansatz.png)\
...
Ansatz](figures/Differentiable Physics/Deep Quantum/Deep Electronic Schrodingers/Ferminet Ansatz.png)\
