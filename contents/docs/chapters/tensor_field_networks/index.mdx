...
(\vec\{r\}_a, x_a) &= (R(g)\vec\{r\}_a, \rho^X(g)x_a)
...
architectures.](figures/Differentiable Physics/Molecular ML/Tensor Field Networks/Vacm dictionaries.png)\
...
<https://arxiv.org/pdf/1802.08219.pdf>](figures/Differentiable Physics/Molecular ML/Tensor Field Networks/Information flow_tf arch.png)\
