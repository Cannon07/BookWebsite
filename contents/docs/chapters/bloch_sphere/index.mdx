...
the Bloch sphere as the diagram below shows. ![The Bloch shere provides
a representation of the state space of a two level quantum
system.](/BookWebsite/figures/bloch_sphere/bloch_sphere.png)
