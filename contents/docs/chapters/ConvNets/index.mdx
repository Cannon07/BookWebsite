...
output grid.
](figures/Differentiable Models/conv_nets/convolutional network241.jpg)\
...
![image](/BookWebsite/code-blocks/ConvNets/code_block_0_35924f43.png)
...
![image](/BookWebsite/code-blocks/ConvNets/code_block_1_fa164885.png) By zero-padding before applying
convolution, we get the following sequence of shape transformations
$$\begin\{aligned\}
...
![A residual layer preserves its input in addition to applying
convolutions.](/BookWebsite/figures/ConvNets/residual.jpeg)

![image](/BookWebsite/code-blocks/ConvNets/code_block_2_10daca19.png)
