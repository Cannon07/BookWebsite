...
In
[$$chap:simple_physics$$]\{reference-type="ref+label"
...
![Sir Issac Newton: \"I do not know what I may appear to the world, but
...
undiscovered before
me.\"](/BookWebsite/figures/newtons_laws/newton.jpg)
...
[$$newton2momentum$$]\{reference-type="ref"
...
![image](/BookWebsite/code-blocks/newtons_laws/code_block_0_8fb329cc.png)
...
1.  Derive Newton's Second Law in momentum form (Definition
    ...
    [$$newton2$$]\{reference-type="ref" reference="newton2"\}).
