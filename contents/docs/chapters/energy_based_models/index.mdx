...
[$$fig:boltzmann_machine$$]\{reference-type="ref"
...
![Example of a Boltzmann
Machine](/BookWebsite/figures/energy_based_models/Boltzmannexamplev1.png)

![image](/BookWebsite/code-blocks/energy_based_models/code_block_0_5a9e5314.png)
...
[$$fig:rbm$$]\{reference-type="ref" reference="fig:rbm"\}).

![Example of a Restricted Boltzmann
Machine](/BookWebsite/figures/energy_based_models/restricted_boltzmann_machine.png)
...
function $Z$ that the naive method of computing $Z$ (exhaustively
summing over all states) could be computationally intractable, unless a
cleverly designed algorithm could exploit regularities in the
probability distribution to compute $Z$ faster. In the case of
restricted Boltzmann machines, the partition function $Z$ is
intractable. The intractable partition function $Z$ implies that the
normalized joint probability distribution $P(v)$ is also intractable to
evaluate.
...
![image](/BookWebsite/code-blocks/energy_based_models/code_block_1_b60ea699.png)
...
2.  While not converged:
    ...
    1.  Update all hidden units in parallel using Eq.
        [$$hidden$$]\{reference-type="ref" reference="hidden"\}

    2.  Update all visible units in parallel to get "reconstructions"
        using Eq. [$$visible$$]\{reference-type="ref"
        reference="visible"\}
    ...
    4.  Update the coefficients of the energy model using Eqs.
        [$$weights1$$]\{reference-type="ref"
        reference="weights1"\}-[$$weights3$$]\{reference-type="ref"
        reference="weights3"\}
...
![image](/BookWebsite/code-blocks/energy_based_models/code_block_2_b6717af3.png)
