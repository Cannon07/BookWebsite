...
in the simply typed lambda calculus <div className="code-block-with-latex">
...
example in <div className="code-block-with-latex">
<pre><code className="language-python">
$\lambda x : \tau . e$
</code></pre>
</div> The variable $x$ is bound
within expression $e$. On the other hand the plain variable
<div className="code-block-with-latex">
<pre><code className="language-python">
$x$
</code></pre>
</div> is free. In programming languages,
