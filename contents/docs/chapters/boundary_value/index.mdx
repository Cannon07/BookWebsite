...
![For finite-difference approach, time is divided into a series of time
steps.](/BookWebsite/figures/boundary_value/hyperloop.PNG)

As shown in Figure [$$fd:fig:1$$]\{reference-type="ref"
...
![image](/BookWebsite/code-blocks/boundary_value/code_block_0_c1bbf40c.png)
