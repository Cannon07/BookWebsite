...
[$$chap:harmonic$$]\{reference-type="ref+label"
...
![Wave-packet representations for the eigenstates, $n = 0$ to $7$ for
the harmonic oscillator. The horizontal axis shows the position $x$.
](/BookWebsite/figures/quantum_oscillators/harmonicoscillator.png)
...
Fig. [$$fig:harmonicoscillator$$]\{reference-type="ref"
...
Fig. [$$fig:partinbox$$]\{reference-type="ref"
reference="fig:partinbox"\}.

![The potential energy function for a particle in a box.
](/BookWebsite/figures/quantum_oscillators/particle_in_box.png)
...
![Solution for the wave-packets for the first four states, $n=1,2,3,4$,
in a one-dimensional particle in a
box](/BookWebsite/figures/quantum_oscillators/schrodingereqnsoln.png)
...
Fig. [$$fig:schrodingereqnsoln$$]\{reference-type="ref"
