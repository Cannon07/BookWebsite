...
provides a formula to compute intermediate values. ![Examples of
interpolating polynomials:(a) first-order (linear) (b) second-order
(quadratic or parabolic) (c) third-order
(cubic)](/BookWebsite/figures/data_interpolation/interpolation.PNG)
...
Fig.[$$fig:2$$]\{reference-type="ref" reference="fig:2"\}. Using
similar triangles,

![Graphical depiction of linear
interpolation.](/BookWebsite/figures/data_interpolation/linear.png)
$$\begin\{aligned\}
...
divided differences. ![Graphical depiction of the recursive nature of
finite divided
differences.](/BookWebsite/figures/data_interpolation/polynomial.png)
