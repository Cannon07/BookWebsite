...
\begin{document}
\chapter{Learning Invariances in Neural Networks}

\label{chap:learning_invariance}
...
"""
Although machine learning has been used to assist physics by speeding up simulations and improving data analysis, a largely unexplored question is whether machine learning can help theoretical physicists for automatic physics discoveries. In this talk, I will demonstrate that machine learning is capable of auto-discovering symmetries and conservation laws of physical systems.
"""
...
References \cite{benton2020learning}, \cite{dehmamy2020lie}, \cite{liu2020ai}, \cite{liu2021machine}.
