...
The pipe $|$ is read as \"such that.\" The entire definition above is
read as \"V star equals the set of phi from V to F such that phi is
linear.\"
...
If there are $p$ copies of $V$ and $q$ copies of $V^*$ we say that the
