...
<style jsx global>{`
  ...
  /* Other styles... */
`}</style>
# Featurizing Crystals and Learning Crystal Structures from Diffraction Data 
...
formats.](figures/Differentiable Physics/Materials ML/deep_reasoning/robocrytallizer.png)\
...
![](/BookWebsite/figures/Differentiable Physics/Materials ML/deep_reasoning/Gomes.png)\
