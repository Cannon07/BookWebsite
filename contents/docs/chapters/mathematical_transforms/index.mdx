...
\
**Prerequisites:**
[$$chap:calculus$$]\{reference-type="ref+label"
reference="chap:calculus"\},
[$$chap:vectors$$]\{reference-type="ref+label"
...
transform of $f$ to be a function $f$\* defined by
...
![image](/BookWebsite/figures/mathematical_transforms/thermo_legendre.png)
