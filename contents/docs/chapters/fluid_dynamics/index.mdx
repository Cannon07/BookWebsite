...
plates.](figures/Physics/fluids/fluid_dynamics/Poiseuille flow.png)\
...
pipe.
](figures/Physics/fluids/fluid_dynamics/Flowpipe_fluid.png)\
...
[$$eq:pipe$$]\{reference-type="ref" reference="eq:pipe"\}:
$$\begin\{aligned\}
