...
(Fig. [1.1]\{reference-type="ref" reference="fig5"\}).

![Schematic showing the atoms in a crystal in their locked,
energy-minimum positions at $T = 0$ and the lattice vibrations that
occur at finite
temperature](figures/Physics/statistical_mechanics/phonon_gas/atoms _in_crystel5.png)\
...
small-$T$ limit (Fig. [$$fig6$$]\{reference-type="ref"
reference="fig6"\}).

![Heat capacity of a crystal predicted by the Einstein model of lattice
vibration](/BookWebsite/figures/phonon_gas/Fig6.png)
...
![Heat capacity of a crystal predicted by the Einstein model and Debye
model of lattice vibration](/BookWebsite/figures/phonon_gas/Fig7.png)
...
(Fig. [$$fig7$$]\{reference-type="ref" reference="fig7"\}). This is
