...
([$$AveN_electrons$$]\{reference-type="ref"
...
(Fig. [$$fig2$$]\{reference-type="ref" reference="fig2"\}), and we
...
Fig. [$$Fig8$$]\{reference-type="ref" reference="Fig8"\}). Inside
...
enclosure of Fig. [$$fig8$$]\{reference-type="ref"
...
The integrand from
([$$Energy_Density$$]\{reference-type="ref"
...
1.  Long wavelength, $\frac\{hc\}\{kT\lambda\} << 1$. Here $$\label\{Eq29\}
    ...
    And ([$$Eq29$$]\{reference-type="ref" reference="Eq29"\})
    becomes $$\label\{Eq30\}
...
2.  Short wavelength, $\frac\{hc\}\{kT\lambda\} >> 1$. Here $$\label\{Eq31\}
    ...
    And ([$$Eq30$$]\{reference-type="ref" reference="Eq30"\})
    becomes $$\label\{Eq32\}
...
([$$Part_photon$$]\{reference-type="ref"
...
in the constant of $a$ of ([$$Eq35$$]\{reference-type="ref"
...
Comparing ([$$Eq40$$]\{reference-type="ref" reference="Eq40"\}) and
([$$Eq35$$]\{reference-type="ref" reference="Eq35"\}), we get:
$$\label\{Eq43\}
F = -\frac\{1\}\{3\} aVT^\{4\}$$
