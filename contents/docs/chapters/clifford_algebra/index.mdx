...
<style jsx global>{`
  ...
  /* Other styles... */
`}</style>
# Clifford Group Equivariant Networks 
...
![image](/BookWebsite/figures/Differentiable Physics/Neural Diff Eq/Clifford Algebra/wedge_product1.png)
...
![image](/BookWebsite/figures/Differentiable Physics/Neural Diff Eq/Clifford Algebra/basis1.png)
