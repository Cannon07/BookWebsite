...
in the simply typed lambda calculus ![image](/BookWebsite/code-blocks/simply_typed_lambda_calculus/code_block_0_6cc44741.png)
...
example in ![image](/BookWebsite/code-blocks/simply_typed_lambda_calculus/code_block_1_9de25f2a.png) The variable $x$ is bound
within expression $e$. On the other hand the plain variable
![image](/BookWebsite/code-blocks/simply_typed_lambda_calculus/code_block_2_c4c27d92.png) is free. In programming languages,
arguments to functions are passed in as bound variables that can be used
