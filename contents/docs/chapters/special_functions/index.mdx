...
$Y_\{\ell \}^\{m\}(\theta ,\varphi)$ in angular direction
$(\theta,\varphi)$](/BookWebsite/figures/special_functions/spherical_harmonics1.png)
...
$C^\{LM\} _\{\ell_1 m_1 \ell_2 m_2\}$

$$\begin\{aligned\}
Y^\{m_1\} _\{\ell_1\} Y^\{m_2\} _\{\ell_2\} &= \sum _\{L, M\} C^\{L0\} _\{\ell_1 0 \ell_2 0\} C^\{LM\} _\{\ell_1 m_1 \ell_2 m_2\} Y^M _\{L\}
\end\{aligned\}$$
...
integers.](/BookWebsite/figures/special_functions/gamma_function.png)
...
$J_\alpha$.](/BookWebsite/figures/special_functions/bessel_first_kind.png)

![A plot of Bessel's functions of the second kind
$Y_\alpha$.](/BookWebsite/figures/special_functions/bessel_second_kind.png)
...
$\mathrm\{Bi\}(x)$](/BookWebsite/figures/special_functions/airy_functions.png)
