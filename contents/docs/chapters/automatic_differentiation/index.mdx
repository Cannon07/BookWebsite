...
![Automatic Differentiation
Scheme](figures/Differentiable Programming/Programming Languages/automatic_differentiation/AutomaticDifferentiationNutshell0.png)\
...
![image](/BookWebsite/code-blocks/automatic_differentiation/code_block_0_92e45b71.png)
...
![image](/BookWebsite/code-blocks/automatic_differentiation/code_block_1_acb7ba4a.png)

We can now compute the dependence of the two layer network on its first
input as given by the gradient.

![image](/BookWebsite/code-blocks/automatic_differentiation/code_block_2_6945cd68.png)
...
1.  Compute the following derivatives. Note that we have multiple
    ...
    ![image](/BookWebsite/code-blocks/automatic_differentiation/code_block_3_eff601b3.png)
