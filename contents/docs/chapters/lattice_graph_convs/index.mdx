...
Modeled](figures/Differentiable Physics/Materials ML/lattice_convolution/irreversible_dissociation (1).png)\

Note how in Figure [1.1]\{reference-type="ref"
...
label="fig:lattice_cluster_expansion"></span></p>
</figure>
...
alt="image" /> <span id="fig:lcnn_architecture"
label="fig:lcnn_architecture"></span></p>
</figure>
...
![A representation of a face-centered cubic unit
cell](/BookWebsite/figures/lattice_graph_convs/face_centered_cubic.png)
...
![](/BookWebsite/figures/lattice_graph_convs/lattice_unit_cell.png)
...
![](/BookWebsite/figures/Differentiable Physics/Materials ML/lattice_convolution/Lattice_Cnn_Transform.png)\
