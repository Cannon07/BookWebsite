...
Table [\[phs:theory:toy\]](#phs:theory:toy)\{reference-type="ref"
...
[]\{#phs:theory:toy label="phs:theory:toy"\}
:::
...
$$\begin\{aligned\}
\mathcal\{W\}^* &= \argmin\_\{\mathcal\{W\}\} \mathcal\{L\}(\textrm\{PhysicalTheory\}, \mathcal\{D\})
\end\{aligned\}$$
...
$$\begin\{aligned\}
    \mathcal\{O\}^* &= \argmin\_\{\mathcal\{O\}, \mathcal\{W\}\} \mathcal\{L\}(\textrm\{PhysicalTheory\}, \mathcal\{D\})
\end\{aligned\}$$
...
$$\begin\{aligned\}
B^* &= B\left (\argmin\_\{\mathcal\{W\}\} \mathcal\{L\}(\textrm\{PhysicalTheory\}, \mathcal\{D\}) \right)
\end\{aligned\}$$
