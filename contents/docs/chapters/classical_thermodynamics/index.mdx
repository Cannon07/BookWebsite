...
![The total internal energy of a system containing two subsystems, is
the sum of the internal energies of each
subsystem](/BookWebsite/figures/classical_thermodynamics/thermo_2_systems.png)
...
of the system (Fig.[$$fig:Fig1$$]\{reference-type="ref"
reference="fig:Fig1"\}).
...
differential change. Equation ([$$Eq5$$]\{reference-type="ref"
...
![Closed, Isolated System containing two
subsystem](/BookWebsite/figures/classical_thermodynamics/thermo_closed_isolated.png)

Consider a closed, isolated system which cannot exchange heat, work, or
particles with its surroundings
(Fig. [$$fig:Fig2$$]\{reference-type="ref"
...
![image](/BookWebsite/code-blocks/classical_thermodynamics/code_block_0_e73e424f.png)
...
![image](/BookWebsite/code-blocks/classical_thermodynamics/code_block_1_a73cc92c.png)
