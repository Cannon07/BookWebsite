...
curve of $f(x)$ between $x = a$ and $b$. ![Graphical representation of
the integral of $f(x)$ between the limits $x = a$ to
$b$.](/BookWebsite/figures/integration_trapezoidal/integration.PNG)
![(a) Area of a field bounded by a meandering stream and two roads. (b)
Cross-sectional area of a river. (c) Net force due to a nonuniform wind
blowing against the side of a
skyscraper.](/BookWebsite/figures/integration_trapezoidal/intro.png)
...
\end\{aligned\}$$ ![The approximation of an integral by the area under
(a) a straight line and (b) a
parabola.](/BookWebsite/figures/integration_trapezoidal/polynomial.png)
where $n$ is the order of the polynomial. For example, in Fig.
[$$fig:3$$]\{reference-type="ref" reference="fig:3"\}a, a
first-order polynomial (a straight line) is used as an approximation. In
Fig. [$$fig:3$$]\{reference-type="ref" reference="fig:3"\}b, a
...
[$$fig:4$$]\{reference-type="ref" reference="fig:4"\}, three
straight-line segments are used to approximate the integral.
Higher-order polynomials can be utilized for the same purpose. ![The
approximation of an integral by the area under three straight-line
segments.](/BookWebsite/figures/integration_trapezoidal/piecewise.png)
...
Fig.[$$fig:5$$]\{reference-type="ref" reference="fig:5"\}. Now
...
follows ![image](/BookWebsite/code-blocks/integration_trapezoidal/code_block_0_de6428ca.png)

![Graphical depiction of the trapezoidal
rule.](/BookWebsite/figures/integration_trapezoidal/trapezoidal.png)
...
[$$fig:6$$]\{reference-type="ref" reference="fig:6"\}). The areas
...
h = \dfrac\{b-a\}\{n\}
\end\{aligned\}$$ ![Composite trapezoidal
rule.](/BookWebsite/figures/integration_trapezoidal/composite.png) If
$a$ and $b$ are designated as $x_0$ and $x_n$, respectively, the total
integral can be represented as $$\begin\{aligned\}
...
![image](/BookWebsite/code-blocks/integration_trapezoidal/code_block_1_dab76743.png)
