...
optimal values. ![Difference between roots and
optima](/BookWebsite/figures/golden_section/optimization.png)
...
[$$fig:1$$]\{reference-type="ref" reference="fig:1"\}. Root
...
As can be seen in Figure [$$fig:1$$]\{reference-type="ref"
...
![(a) One-dimensional Optimization (b) Two-dimensional Optimization
](/BookWebsite/figures/golden_section/onedimensional_1.png)

One-dimensional problems involve functions that depend on a single
dependent variable. As in Figure
[$$fig:2$$]\{reference-type="ref" reference="fig:2"\}a, the search
...
[$$fig:2$$]\{reference-type="ref" reference="fig:2"\}b). The
...
[$$fig:2$$]\{reference-type="ref" reference="fig:2"\}a.

## One-dimensional Optimization

Consider the function depicted in Figure
[$$fig:3$$]\{reference-type="ref" reference="fig:3"\}. Recall that
...
[$$fig:3$$]\{reference-type="ref" reference="fig:3"\}, the *global
...
![Function asymptotically approaching zero at plus and minus $\infty$
](/BookWebsite/figures/golden_section/onedimensional_2.png)

## Golden-Section Search

Consider a continuous function $f(x)$ over the interval $[x_l,x_u]$ that
contains a single minimum as shown in Figure
[$$fig:4$$]\{reference-type="ref" reference="fig:4"\}a , and hence
...
-   If, as in Figure [$$fig:4$$]\{reference-type="ref"
...
![(a) Initial step (b) Second step of the search
algorithm](/BookWebsite/figures/golden_section/goldensection_2.png) As
the iterations are repeated, the interval containing the extremum is
...
[$$fig:5$$]\{reference-type="ref" reference="fig:5"\} where
...
[$$fig:5$$]\{reference-type="ref" reference="fig:5"\}, it can be
seen
...
(\phi)^2 + \phi - 1 &= 0\\
\phi &= \dfrac\{-1+\sqrt5\}\{2\}
\end\{aligned\}$$ ![Algorithm of Golden Section search
](/BookWebsite/figures/golden_section/goldensection_3.png) The other
root is neglected as we need $\phi$ to be greater than $1/2$ as the
reduction in range needs to be symmetric. Therefore,
...
![image](/BookWebsite/code-blocks/golden_section/code_block_0_f3b8f890.png)
:::
