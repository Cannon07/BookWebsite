...
![image](/BookWebsite/code-blocks/Integral_Programming/code_block_0_b1ddf6ba.png)
...
![image](/BookWebsite/code-blocks/Integral_Programming/code_block_1_972eeb6b.png)
...
![image](/BookWebsite/code-blocks/Integral_Programming/code_block_2_6615db2e.png) and evaluated numerically. Techniques
from perturbation theory can be used to perform approximations in a
structured fashion which we can encode into algorithmic solvers.
