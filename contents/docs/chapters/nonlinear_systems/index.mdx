...
<style jsx global>{`
  ...
  /* Other styles... */
`}</style>
# Approaching Nonlinear Systems with Newton's Method 
...
![Planar Robotic arm with 2
actuators](/BookWebsite/figures/nonlinear_systems/RobotArm.PNG)
...
![image](/BookWebsite/code-blocks/nonlinear_systems/code_block_0_985e77fd.png)

We now define a Newton's method and apply it to this system.

![image](/BookWebsite/code-blocks/nonlinear_systems/code_block_1_72989257.png)
