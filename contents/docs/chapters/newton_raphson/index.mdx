...
(right)](/BookWebsite/figures/newton_raphson/openmethod.PNG) In the
bracketing methods of root-finding, the root is located within an
...
Figure [$$fig:1$$]\{reference-type="ref" reference="fig:1"\} by
...
method](/BookWebsite/figures/newton_raphson/newtonraphson.PNG)
...
convergence](/BookWebsite/figures/newton_raphson/newtonraphsonpoor.PNG)
...
![image](/BookWebsite/code-blocks/newton_raphson/code_block_0_cf2c132a.png) Next we implement Newton-Raphson
![image](/BookWebsite/code-blocks/newton_raphson/code_block_1_eb60e1db.png)
...
![image](/BookWebsite/code-blocks/newton_raphson/code_block_2_87081ea4.png)
...
![image](/BookWebsite/code-blocks/newton_raphson/code_block_3_1d7b9ee1.png)
