...
[]\
<https://en.wikipedia.org/wiki/Spherical_harmonics#/media/File:Spherical_Harmonics.png>.](figures/Mathematical Foundations/special_functions/spherical_harmonics1.png)\
...
integers.](figures/Mathematical Foundations/special_functions/gamma_function.png)\
...
$J_\alpha$.](figures/Mathematical Foundations/special_functions/bessel_first_kind.png)\

![A plot of Bessel's functions of the second kind
$Y_\alpha$.](figures/Mathematical Foundations/special_functions/bessel_second_kind.png)\
...
$\mathrm\{Bi\}(x)$](figures/Mathematical Foundations/special_functions/airy_functions.png)\
