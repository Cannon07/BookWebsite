...
In order to turn this integral into a numerical algorithm, we partition
...
forward network that maps $X_\{t_n\}$ to the estimated term

$$\begin\{aligned\}
    X_\{t_n\} \to h^1_n \to h^2_n \dotsc \to h^H_n \to \nabla u(t_n, X_\{t_n\})
\end\{aligned\}$$ We can convert this definition into Physika code

![image](/BookWebsite/code-blocks/high_dimensional_pde/code_block_0_90a14621.png)
...
the known functions $f$ and $\sigma$. $$\begin\{aligned\}
    (u(t_n, X_\{t_n\}), \nabla u(t_n, X_\{t_n\}), W_\{t_\{n+1\}\} %- W_\{t_n\}) \mapsto u(t_\{n+1\}, X_\{t_\{n+1\}\})
\end\{aligned\}$$

![image](/BookWebsite/code-blocks/high_dimensional_pde/code_block_1_d52ecb1f.png)
...
![image](/BookWebsite/code-blocks/high_dimensional_pde/code_block_2_a266d58e.png)
