...
[$$eq_contTime$$]\{reference-type="ref"
...
[$$eq_generalform$$]\{reference-type="ref"
...
##### The General Form of the Runge-Kutta Method \
...
[$$eq_discrete$$]\{reference-type="ref"
...
Domain](figures/allenCahn_PINN.png)\
:::
...
![image](/BookWebsite/figures/Burgers_CT_inference_book.png) \> *Burgers' equation:*
...
### Example: (Schrödinger Equation) (contd.) \
...
![image](/BookWebsite/figures/NLS_bookl.png) \> *Schrödinger equation:* **Top:**
