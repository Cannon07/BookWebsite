...
<style jsx global>{`
  ...
  /* Other styles... */
`}</style>
# Errors and False Position Method 
...
![Root finding using the False Position
Method](/BookWebsite/figures/errors_and_false_position/falseposition.PNG)
...
[$$fig:1$$]\{reference-type="ref" reference="fig:1"\}). The
...
[$$fig:3$$]\{reference-type="ref" reference="fig:3"\}. The
...
![An example with a series of measurements with the true value at
bull's eye: (a) inaccurate and imprecise, (b) accurate and imprecise,
(c) inaccurate and precise, and (d) accurate and
precise.](/BookWebsite/figures/errors_and_false_position/accuracy.png)
