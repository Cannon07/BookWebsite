...
We define the type of an array as <div className="code-block-with-latex">
<pre><code className="language-python">
[language=python]
x : $\mathbb{R}$[n]
</code></pre>
...
</div> The type of a tensor is similar to the
...
</div> In mathematical tensor notation we
...
represented as a code snippet <div className="code-block-with-latex">
<pre><code className="language-python">
[language=python]
T: $\mathbb{R}$[$+n$, $-m$]
v: $\mathbb{R}$[$+m$]
...
covariances properly. <div className="code-block-with-latex">
<pre><code className="language-python">
[language=python]
T: $\mathbb{R}$[+m, +n, -o]
U: $\mathbb{R}$[+o]
...
</div> What is the type of $v$? We write
<div className="code-block-with-latex">
<pre><code className="language-python">
[language=python]
v: $\mathbb{R}$ $\to$ $T \mathbb{R}^3$
</code></pre>
</div> Let's write down a type for the
...
functions. <div className="code-block-with-latex">
<pre><code className="language-python">
[language=python]
...
</div> We could try to write this type as
<div className="code-block-with-latex">
<pre><code className="language-python">
[language=python]
...
keyword. <div className="code-block-with-latex">
<pre><code className="language-python">
[language=python]
