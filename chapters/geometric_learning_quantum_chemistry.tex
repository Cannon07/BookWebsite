...
\chapter{Geometric Learning in Quantum Chemistry}
\label{chap:geometric_quantum}
...
"""
We present a geometric deep learning method for modeling molecular properties using inputs obtained from low-level atom-orbital-basis quantum chemistry simulations. The proposed learning framework is strictly equivariant with respect to coordinate transformations without the need for a predefined descriptor-generation procedure. On diverse downstream benchmarks, our method shows excellent chemical-space transferability and predicts various real-space and energy-space properties within the accuracy of density functional theory at an order-of-magnitudes reduced computational cost. The framework presented here is readily applicable to alternative featurization on either molecular or periodic systems.
"""

References \cite{qiao2020orbnet}, \cite{qiao2021unite}
