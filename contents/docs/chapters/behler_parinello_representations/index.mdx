...
<style jsx global>{`
  ...
  /* Other styles... */
`}</style>
# Behler-Parinello Representations 
...
$E_i$.](figures/Differentiable Physics/Neural Potentials/Behler-Parinello/bp_architecture.png)\
...
![image](/BookWebsite/code-blocks/behler_parinello_representations/code_block_0_b62ade98.png)
