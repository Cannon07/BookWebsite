...
\
**Prerequisites:**
[$$chap:manifold$$]\{reference-type="ref+label"
...
define the covariant derivative to be
$$(\nabla_v f)_p = (f \circ \phi)'(0)$$

$$= \lim_\{t \to 0\} \frac\{f(\phi(t)) - f(p)\}\{t\}$$ We can then view the
covariant derivative as a function mapping points in the manifold $M$ to
real scalars $(nabla_v f)_p$ $$\begin\{aligned\}
