...
\end\{aligned\}$$ We can transform this description into Physika code as
follows ![image](/BookWebsite/code-blocks/normalizing_flows/code_block_0_a7c12787.png)

![image](/BookWebsite/code-blocks/normalizing_flows/code_block_1_a9914cf4.png)
