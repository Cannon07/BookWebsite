...
interactions (Fig. [$$fig1$$]\{reference-type="ref"
reference="fig1"\}).

![Hierarchical assembly of chromatin and the nucleosome core particle.
Our meter-long genome is packaged into a micronsized nucleus with the
aid of cationic proteins called
histones.](/BookWebsite/figures/electrolytes/fig1.png)
...
## *Electrostatic potential around a charged cylinder* \
...
(Fig [$$fig2$$]\{reference-type="ref" reference="fig2"\}). The
interactions between charges are dramatically reduced due to the
*screening* of the electostatic interactions
(Fig [$$fig3$$]\{reference-type="ref" reference="fig3"\}).

![Schematic of the salt-screening effect for a polyelectrolyte. The
density of positive and negative counter-ions are colored red and blue,
respectively. Electro-neutrality requires the total charge in solution
to be zero, thus the bulk concentration is purple (equal positive and
negative).](/BookWebsite/figures/electrolytes/fig2.png)
...
![Schematic of the salt-screening effect between two isolated
ions.](/BookWebsite/figures/electrolytes/fig3.png)
...
(Fig. [$$Poisson-Boltzmann$$]\{reference-type="ref"
reference="Poisson-Boltzmann"\})

![Schematic of the $Cl^-$ and $Na^+$ concentrations at a distance $r$
from a negatively charged surface at
$r = 0$](/BookWebsite/figures/electrolytes/Poisson-Boltzmann.png)
...
We define the Debye length (Fig [$$fig4$$]\{reference-type="ref"
...
![Plot of the Debye length $l_D$ versus the salt concentration $n_s$
for monovalent salt in water at room
temperature.](/BookWebsite/figures/electrolytes/fig4.png)
...
a (Fig. [$$fig5$$]\{reference-type="ref" reference="fig5"\}), which
...
![Schematic for the short-range interaction between a charged cylinder
(polymer) and a surrounding solution of dilute
ions.](/BookWebsite/figures/electrolytes/fig5.png)
