...
Paths.](figures/Physics/quantum_mechanics/path_integrals/Expansion of Paths (1).png)\

You can intuitively think of this expansion as traveling over all
possible paths from $q$ to $q'$.

![image](/BookWebsite/code-blocks/path_integrals/code_block_0_dac5edbf.png)
...
2.  Prove the expansion equation for paths given in Equation
    [$$pathexpansion$$]\{reference-type="ref"
