...
![image](/BookWebsite/code-blocks/cormorant/code_block_0_dde68145.png) where $d$ is the dimensionality of the
atomic feature vector. We can then define the input transformation that
transforms each atom into its atomic feature representation.
![image](/BookWebsite/code-blocks/cormorant/code_block_1_9e8e70d5.png) Here $Z_i$ is the atom type and $r_i$
is the location of the atom in $\mathbb\{R\}^3$.

![image](/BookWebsite/code-blocks/cormorant/code_block_2_d07664f1.png)
...
![image](/BookWebsite/code-blocks/cormorant/code_block_3_14d67c7a.png) The `CGLayer` is built out of three
simpler primitives: `EdgeNetwork`, `EdgeToVertex`, and `VertexNetwork`.
The edge network is a small modification of the MPNN architecture we saw
in a previous chapter

![image](/BookWebsite/code-blocks/cormorant/code_block_4_f852ac24.png)

![image](/BookWebsite/code-blocks/cormorant/code_block_5_095d7838.png)

![image](/BookWebsite/code-blocks/cormorant/code_block_6_b69ec316.png)

The output transformation combines the learned feature representations
from all the layers into a scalar prediction
![image](/BookWebsite/code-blocks/cormorant/code_block_7_cec3d595.png)
...
![image](/BookWebsite/code-blocks/cormorant/code_block_8_dc42a302.png)
