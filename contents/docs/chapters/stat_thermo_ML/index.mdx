...
<style jsx global>{`
  ...
  /* Other styles... */
`}</style>
# Statistical Thermodynamics and Machine Learning 
...
control.](figures/Physics/statistical_mechanics/stat_thermo_ML/Stat_thermo_fig1.png)\
...
in Figure [1.1]\{reference-type="ref" reference="fig1"\} as
...
jointly.](figures/Physics/statistical_mechanics/stat_thermo_ML/Stat_thermo_fig2.png)\
...
represented in Figure [1.2]\{reference-type="ref"
