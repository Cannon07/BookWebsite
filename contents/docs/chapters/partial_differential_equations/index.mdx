...
We claim that any equation of the form $$u(x, y) = f(x) + g(y)$$ will be
a solution to this equation. Note that this means that there exists an
extremely large solution space of equations for this simple PDE.
