...
![image](/BookWebsite/code-blocks/electrical_circuits/code_block_0_48ae7a41.png) The next basic circuit element is the
capacitor, which stores electric energy in the electric field. The
capacitor has two separated plates. As charge $Q$ flows, a voltage
difference $V$ builds up across the plates. The defining equation of a
...
[$$rc_simple$$]\{reference-type="ref" reference="rc_simple"\}.
...
![Simple RC Circuit.
](/BookWebsite/figures/electrical_circuits/RC_simple.png)

![RC Circuit.
](/BookWebsite/figures/electrical_circuits/RC_circuit.png)
