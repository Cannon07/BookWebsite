...
![Graphical interpretations are useful for understanding the properties
of the functions. This figure shows a number of ways in which roots can
occur in an interval prescribed by a lower bound $x_l$ and an upper
bound $x_u$. In general, if $f(x_l)$ and $f(x_u)$ have opposite signs,
there are an odd number of roots in the
interval.](/BookWebsite/figures/bracketing_and_bisection/graphical.PNG)
...
![Illustration of the algorithm for incremental
search](/BookWebsite/figures/bracketing_and_bisection/Increment.png)

A graphical depiction of incremental search with six intervals is shown
in the Figure [$$fig:2$$]\{reference-type="ref"
...
![Illustration of the algorithm for bisection
method](/BookWebsite/figures/bracketing_and_bisection/Bisection.png)
...
right. ![Special cases a) Multiple roots b) Discontinuous
functions](/BookWebsite/figures/bracketing_and_bisection/exception.png)
