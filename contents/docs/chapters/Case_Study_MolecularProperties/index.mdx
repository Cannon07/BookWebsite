...
<style jsx global>{`
  ...
  /* Other styles... */
`}</style>
# Case study: Identifying Photovoltaic Materials 
...
[$$fig:properties$$]\{reference-type="ref"
...
[$$tab:results$$]\{reference-type="ref"
reference="tab:results"\}.

Table [$$tab:results$$]\{reference-type="ref"
...
[$$fig:lossEpoch$$]\{reference-type="ref"
