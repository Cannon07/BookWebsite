...
In
[$$chap:electrostatics$$]\{reference-type="ref+label"
...
![The current is given by the rate flow of charge through a given
region of
space.](/BookWebsite/figures/electric_current_and_magnetic_field/electric_current_charges.png)
...
Equation [$$lorentz:force$$]\{reference-type="ref"
...
![image](/BookWebsite/code-blocks/electric_current_and_magnetic_field/code_block_0_5147fdf8.png)
...
![A charged particle in a magnetic field.
](figures/Physics/electromagnetism/electric_current/Charged Particle in mag field.png)\
...
](figures/Physics/electromagnetism/electric_current/Current in curve.png)\
