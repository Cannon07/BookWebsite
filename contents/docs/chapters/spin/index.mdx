...
[$$fig:twoLevelSystem$$]\{reference-type="ref"
...
![Schematic of a two-level system
](/BookWebsite/figures/spin/twoLevelSystem.png) The Hamiltonian
operator of the two-level atom is in the energy representation
$$\begin\{aligned\}
