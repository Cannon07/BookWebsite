...
(Fig.[$$fig1a$$]\{reference-type="ref" reference="fig1a"\}), we
...
Using ([$$Eq1$$]\{reference-type="ref" reference="Eq1"\}) and
([$$Eq2$$]\{reference-type="ref" reference="Eq2"\}), we have
$N_H=(N+X)/2$ and $N_T=(N-X)/2$. This gives (Fig.
[$$fig1$$]\{reference-type="ref" reference="fig1"\}): $$\label\{Eq4\}
...
(Fig. [$$fig2$$]\{reference-type="ref" reference="fig2"\}):
